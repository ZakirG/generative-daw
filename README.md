...
This webapp is a suite of tools for randomized music composition. It can be used for the rapid generation and editing of compositions that conform to user-applied stylistic constraints.
